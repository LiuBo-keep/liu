...
<script type="text/javascript">
    ...
    map.centerAndZoom(new BMap.Point(117.234678,39.131106), 17);  // 初始化地图,设置中心点坐标和地图级别
    map.enableScrollWheelZoom(true);     //开启鼠标滚轮缩放
    var point = new BMap.Point(117.234678,39.131106);
    ...
    var infoWindow = new BMap.InfoWindow("地址：天津市大学软件学院", opts);  // 创建信息窗口对象
