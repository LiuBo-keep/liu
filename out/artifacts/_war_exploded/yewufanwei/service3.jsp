...
<div class="sec aboutpg container">
    <div class="pg-nav col-sm-3">
        ...
        <ul>
            <li><a href="service.jsp">物流卡航</a></li>
            <li><a href="service1.jsp">物流空运</a></li>
            <li><a href="service2.jsp">限时到达</a></li>
            <li><a href="service3.jsp">物流普运</a></li>
            <li><a href="service4.jsp">城际快线</a></li>
            <li><a href="service5.jsp">合作共赢</a></li>
        </ul>
        <div class="tit-ol">
            <p>在线下单</p>
        </div>
    ...
    <div class="col-sm-9">
        ...
        <div class="ser-con con-pad">
            <p>某某物流普运线路齐全、价格实惠，服务网络覆盖全国各大区域。提供具有经济效益的陆运零担运输，以满足发货时线路多、时间要求不高的客户群体需求。</p>
            <h2>网络完善</h2>
