...
<div class="content">
    <div class="contentLeft">
        <canvas class="cans" width="600px" height="350px"></canvas>
        <p>每月购物量</p>
        <span>每月送货量</span>
    </div>
    <div class="contentRight">
        <canvas class="can" width="600px" height="350px"></canvas>
    </div>
    <div class="contentFooter" style="height:50%;width: 100%; margin: 0">
